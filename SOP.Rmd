---
title: "CLINICAL DECOMPOSITION EXTRACTION"
date: "2026-05-11"
output:
  word_document:
    toc: false
...
~ 5-6 minutes per sample, all 7 labels (takes into consideration that its unlikely a patient has all positives for all labels, that will be the max time)\
~ 3.685 days for all 1100 samples

### Metrics and  Earliest Date of each Event

<img src="results.png" align="left" width="800">
<br clear="left">
